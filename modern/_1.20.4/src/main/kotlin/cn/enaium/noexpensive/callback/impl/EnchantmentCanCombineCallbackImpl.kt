...
class EnchantmentCanCombineCallbackImpl : EnchantmentCanCombineCallback {
    override fun interact(enchantment1: Enchantment, enchantment2: Enchantment): ActionResult {
        val enchantment1Name = Objects.requireNonNull(Registries.ENCHANTMENT.getId(enchantment1)).toString()
        val enchantment2Name = Objects.requireNonNull(Registries.ENCHANTMENT.getId(enchantment2)).toString()
