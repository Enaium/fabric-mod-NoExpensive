...
class EnchantmentCanCombineCallbackImpl : EnchantmentCanCombineCallback {
    override fun interact(enchantment1: Enchantment, enchantment2: Enchantment): ActionResult {
        val enchantment1Name = Objects.requireNonNull(Enchantment.REGISTRY.getIdentifier(enchantment1)).toString()
        val enchantment2Name = Objects.requireNonNull(Enchantment.REGISTRY.getIdentifier(enchantment2)).toString()
        ...
        return if (enchantment1.differs(enchantment2)) ActionResult.PASS else ActionResult.FAIL
    }
}
