...
public class EnchantmentCanCombineCallbackImpl implements EnchantmentCanCombineCallback {
    ...
    public ActionResult interact(Enchantment enchantment1, Enchantment enchantment2) {
        final String enchantment1Name = Objects.requireNonNull(Enchantment.REGISTRY.getIdentifier(enchantment1)).toString();
        final String enchantment2Name = Objects.requireNonNull(Enchantment.REGISTRY.getIdentifier(enchantment2)).toString();
        ...
        return enchantment1.differs(enchantment2) ? ActionResult.PASS : ActionResult.FAIL;
    }
}
